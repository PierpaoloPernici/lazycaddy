...
// saver, reloader, runtime probe, log source, editor and searcher. The
// variadic options accept an app.Formatter, an app.Saver, an
// app.Reloader, an app.RuntimeStatus, an app.LogSource, an app.Editor, an
// app.Searcher, any combination, or none. The searcher defaults to
// app.NewSearcher(); pass a typed nil app.Searcher to disable it.
