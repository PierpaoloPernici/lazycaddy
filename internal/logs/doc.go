...
// logs payloads. A Tailer is the v0.1 file log source and a JournalSource is
// the v0.2 systemd journal source; both feed a Buffer that the UI renders.
// ParseEntry and HighlightJSON are pure functions over single lines and are
